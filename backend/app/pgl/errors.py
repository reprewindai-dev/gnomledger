...
class MalformedWorkloadIdentifierError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_MALFORMED_WORKLOAD_IDENTIFIER", "Malformed workload_identifier", **kwargs
        )
...
class MissingEphemeralExecutionIdError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_MISSING_EPHEMERAL_EXECUTION_ID", "Missing ephemeral_execution_id", **kwargs
        )
...
class MissingAuthorityHashError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_MISSING_AUTHORITY_HASH",
            "Missing authority_hash for consequence/truth-transition",
            **kwargs,
        )
...
class MissingPolicyDecisionHashError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_MISSING_POLICY_DECISION_HASH", "Missing policy_decision_hash", **kwargs
        )
...
class MissingPreviousEventHashError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_MISSING_PREVIOUS_EVENT_HASH",
            "Missing previous_event_hash for non-genesis event",
            **kwargs,
        )
...
class UnlabeledPlaceholderSignatureError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_UNLABELED_PLACEHOLDER_SIGNATURE", "Unlabeled placeholder signature", **kwargs
        )
...
class IdentityChainHashMismatchError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_IDENTITY_CHAIN_HASH_MISMATCH", "Identity chain hash mismatch", **kwargs
        )
...
class PolicyDecisionHashMismatchError(PGLEvidenceError):
    def __init__(self, **kwargs):
        super().__init__(
            "PGL_POLICY_DECISION_HASH_MISMATCH", "Policy decision hash mismatch", **kwargs
        )
